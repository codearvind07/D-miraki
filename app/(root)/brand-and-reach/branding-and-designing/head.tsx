export default function Head() {
  const title = "Branding & Identity Design | DMiraki";
  const description = "Authentic brand identity design and strategy to connect with your audience.";
    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 3, "name": "Branding & Identity Design", "item": url }
        ]
      }) }} />
    </>
  );
