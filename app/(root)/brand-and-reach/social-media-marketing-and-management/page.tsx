...
function SocialMediaMarketingAndManagement() {
  ...
  return (
    <>
      <Head>
        <title>
          Social Media Marketing Services | Community Building by DMiraki
        </title>
        <meta
          name="description"
          content="Transform your social presence into a revenue engine with DMiraki's social media marketing services. Build communities that drive business growth."
        />
      </Head>
