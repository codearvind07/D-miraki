...
export default function SocialMediaMarketingAndManagementClient() {
        ...
        >
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Specialized strategies for each platform to maximize your reach and engagement.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {platformExpertise.map((platform, index) => (
                ...
                >
                  ...
                  <p className="text-gray-600 dark:text-gray-300 mb-6">{platform.description}</p>
                  <div className={`w-full h-2 rounded-full bg-gradient-to-r ${platform.color}`}></div>
                </div>
              ))}
            </div>
          </div>
        ...
        >
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                A proven methodology that ensures consistent results and measurable ROI.
              </p>
            </div>
        ...
        <section className="py-16 lg:py-24 px-4 lg:px-8 bg-white dark:bg-gray-950">
          <div className="max-w-4xl mx-auto text-center bg-gradient-to-r from-blue-50 to-purple-50 dark:from-gray-900 dark:to-gray-800 p-12 rounded-3xl border border-gray-200 dark:border-gray-800 shadow-xl">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
              Let's build a social media strategy that drives real business results.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact-us" className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold py-4 px-8 rounded-full transition-all duration-300 transform hover:-translate-y-1 shadow-lg hover:shadow-xl">
