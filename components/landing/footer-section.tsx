    ...
    <footer id="footer">
      ...
      <section className="container py-20 grid grid-cols-2 md:grid-cols-5 gap-x-12 gap-y-8">
        <div className="col-span-full xl:col-span-2">
          <Link  href="/" className="font-bold text-xl flex font-recoleta">
            d'miraki
          </Link>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div>
            <Link href="/brand-and-reach/social-media-marketing-and-management" className="opacity-60 hover:opacity-100">
              Social Media
            </Link>
          </div>
          <div>
            <Link href="/brand-and-reach/branding-and-designing" className="opacity-60 hover:opacity-100">
              Branding
            </Link>
          </div>
          <div>
            <Link href="/brand-and-reach/profitable-performance-marketing" className="opacity-60 hover:opacity-100">
              Marketing
            </Link>
          </div>
          <div>
            <Link href="/code-and-build/web-design-and-development" className="opacity-60 hover:opacity-100">
              Web Development
            </Link>
          </div>
          <div>
            <Link href="/brand-and-reach/content-creation" className="opacity-60 hover:opacity-100">
              Content Creation
            </Link>
          </div>
          <div>
            <Link href="/code-and-build/ui-and-ux-design" className="opacity-60 hover:opacity-100">
              UI/UX Design
            </Link>
          </div>
        </div>
